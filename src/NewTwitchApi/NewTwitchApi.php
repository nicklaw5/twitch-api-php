...
class NewTwitchApi
{
    ...
    public function __construct(Client $helixGuzzleClient, RequestGenerator $requestGenerator, string $clientId, string $clientSecret, Client $authGuzzleClient = null)
    {
