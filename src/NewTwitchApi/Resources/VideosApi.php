...
class VideosApi extends AbstractResource
{
   ...
   */
  public function getVideos(array $ids = [], string $userId = null, string $gameId = null, string $first = null, string $before = null, string $after = null, string $language = null, string $period = null, string $sort = null, string $type = null, string $bearer): ResponseInterface
  {
      $queryParamsMap = [];
