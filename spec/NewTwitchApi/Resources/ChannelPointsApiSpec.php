...
class ChannelPointsApiSpec extends ObjectBehavior
{
    ...
    function it_should_get_create_custom_reward(Client $guzzleClient, Response $response)
    {
    ...
    function it_should_get_delete_custom_reward(Client $guzzleClient, Response $response)
    {
    ...
    function it_should_get_update_a_single_redemption_status(Client $guzzleClient, Response $response)
    {
    ...
    function it_should_get_update_multiple_redemption_statuses(Client $guzzleClient, Response $response)
    {
