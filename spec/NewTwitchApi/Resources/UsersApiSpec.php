...
class UsersApiSpec extends ObjectBehavior
{
    ...
    public function it_should_get_users_by_ids(Client $guzzleClient, Response $response)
    {
    ...
    public function it_should_get_users_by_usernames(Client $guzzleClient, Response $response)
    {
    ...
    public function it_should_get_users_by_id_and_username(Client $guzzleClient, Response $response)
    {
    ...
    public function it_should_get_a_single_user_by_id(Client $guzzleClient, Response $response)
    {
    ...
    public function it_should_get_users_and_include_email(Client $guzzleClient, Response $response)
    {
    ...
    public function it_should_get_users_by_everything_including_email(Client $guzzleClient, Response $response)
    {
    ...
    public function it_should_get_users_follows_by_follower_id(Client $guzzleClient, Response $response)
    {
    ...
    public function it_should_get_users_follows_by_followed_id(Client $guzzleClient, Response $response)
    {
    ...
    public function it_should_get_users_follows_by_follower_id_and_followed_id(Client $guzzleClient, Response $response)
    {
    ...
    public function it_should_get_users_follows_page_by_first(Client $guzzleClient, Response $response)
    {
    ...
    public function it_should_get_users_follows_page_by_after(Client $guzzleClient, Response $response)
    {
    ...
    public function it_should_get_users_follows_by_everything(Client $guzzleClient, Response $response)
    {
    ...
    public function it_should_get_user_with_access_token(Client $guzzleClient, Response $response)
    {
    ...
    public function it_should_get_user_with_access_token_convenience_method(Client $guzzleClient, Response $response)
    {
        $guzzleClient->send(new Request('GET', 'users', ['Authorization' => 'Bearer TEST_TOKEN']))->willReturn($response);
        $this->getUserByAccessToken('TEST_TOKEN')->shouldBeAnInstanceOf(ResponseInterface::class);
    }

    public function it_should_create_a_follow(Client $guzzleClient, Response $response)
    {
