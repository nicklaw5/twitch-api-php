...
class BitsApiSpec extends ObjectBehavior
{
    ...
    public function it_should_getcheermotes(Client $guzzleClient, Response $response)
    {
    ...
    public function it_should_getcheermotes_by_broadcaster_id(Client $guzzleClient, Response $response)
    {
    ...
    public function it_should_extension_transactions(Client $guzzleClient, Response $response)
    {
    ...
    public function it_should_extension_transactions_with_transaction_id(Client $guzzleClient, Response $response)
    {
    ...
    public function it_should_extension_transactions_with_first(Client $guzzleClient, Response $response)
    {
    ...
    public function it_should_extension_transactions_with_after(Client $guzzleClient, Response $response)
    {
